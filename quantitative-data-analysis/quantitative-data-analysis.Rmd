...
> Note that this code is actually a *mistake*. 5 should be assigned to *Very Happy*, not to *Very Unhappy*. 1 should be assigned to *Very Unhappy*. Having our thinking written down in the form of code or syntax allows us to see that this mistake has been made--and to ultimately correct it--when we are checking over our workflow.
