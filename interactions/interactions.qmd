...
> Our third and final story--and this is where interactions and moderation come in--is that each group has its own regression intercept, **and** *each group now also has its own slope*. One group has a slope of $\beta_1$. The other group has a slope of $\beta_1 + \beta_3$, where $\beta_3$ three indicates how the regression slope for the second group, is different from the regression slope for the first group.
