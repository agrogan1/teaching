...
knitr::include_graphics("imposter-syndrome.png")
...
```{r, fig.height=3, fig.cap="Octavia Butler"}

knitr::include_graphics("octavia-butler.jpg")

```


```{r, fig.height=3, fig.cap="Octavio Paz in the Paris Review"}

knitr::include_graphics("Octavio-Paz_Writing-Paris-Review.jpeg")
