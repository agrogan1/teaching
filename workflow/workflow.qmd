...
![A Common Workflow](workflow.png)
...
> Related to this issue is the idea that it is usually best to store quantitative data in a statistical format such as SPSS or Stata. [Spreadsheets are likely to be a bad tool for storing quantitative data](https://agrogan1.github.io/posts/why-Excel-is-a-bad-format-for-storing-data/). 
...
![Multiple Person Workflows](workflow2.png)
